...
const { registerUser, loginUser, logout, forgotPassword, resetPassword, getUserDetails, updatePassword, updateProfile, getUsers, getSingleUser, updateUser, deleteUser } = require("../controller/userController")
